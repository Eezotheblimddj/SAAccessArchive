...
class MainWindow(wx.Frame):
    ...
    def get_selected_full_path(self):
        """Return the full path (local or remote) of the selected item."""
    ...
    def on_show_favourites(self, event):
        ...
        if result == wx.ID_OK:
            ...
            # The dialog already modified its internal list; persist it.
...
class FavouritesDialog(wx.Dialog):
    ...
    def on_delete(self, event):
        ...
        if self.list_box.GetCount() > 0:
            ...
            # Nothing left; close and let the caller persist an empty list.
...
class WelcomeDialog(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        welcome_text = (
            ...
            "5. Press F1 at any time for the full in-app guide.\n\n"
...
class HelpDialog(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        guide_text = (
            ...
            "removed. A low tone when something fails.\n"
            "\n"
